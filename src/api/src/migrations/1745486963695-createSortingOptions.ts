...
export class CreateSortingOptions1745486963695 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "sorting_options" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "order" character varying NOT NULL, "default" boolean NOT NULL, "code" character varying NOT NULL, CONSTRAINT "PK_86785c87ad2e1df7889ce72e83c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`
